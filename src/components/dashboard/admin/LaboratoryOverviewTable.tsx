import { getLabOverview } from '../../../lib/dataSelectors'
import { useAppData } from '../../../context/AppDataContext'
import { StatusBadge } from '../../ui/StatusBadge'
import { TableCard } from '../shared/TableCard'

interface LaboratoryOverviewTableProps { rows?: ReturnType<typeof getLabOverview> }

export function LaboratoryOverviewTable({ rows: suppliedRows }: LaboratoryOverviewTableProps) {
  const { data } = useAppData()
  const rows = suppliedRows ?? getLabOverview(data)
  return (
